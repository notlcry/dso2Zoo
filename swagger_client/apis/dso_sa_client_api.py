...
class DsoSaClientApi(object):
    ...
    def account_account_id_get(self, account_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.account_account_id_get(account_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method account_account_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `account_account_id_get`")
