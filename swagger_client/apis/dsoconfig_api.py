...
class DsoconfigApi(object):
    ...
    def get_config(self, **kwargs):
        """
        get dso configuration
        this endpoint use to query dso configuration
    ...
    def update_config(self, config, **kwargs):
        """
        send configuration to dso
        this endpoint use to set dso config
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param DsoConfigSO config: configuration (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
